...
wget 'https://www.python.org/ftp/python/2.7.12/Python-2.7.12.tgz' -O /opt/Python-2.7.12.tgz -q > /dev/null 2>&1
cd /opt/
...
wget 'https://pypi.python.org/packages/0d/13/ce6a0a22220f3da7483131bb8212d5791a03c8c3e86ff61b2c6a2de547cd/setuptools-26.0.0.tar.gz#md5=846e21fea62b9a70dfc845d70c400b7e' -O setuptools-26.0.0.tar.gz -q > /dev/null 2>&1
echo "- Verifying file integrity"
...
wget 'https://pypi.python.org/packages/e7/a8/7556133689add8d1a54c0b14aeff0acb03c64707ce100ecd53934da1aa13/pip-8.1.2.tar.gz#md5=87083c0b9867963b29f7aba3613e8f4a' -O pip-8.1.2.tar.gz -q > /dev/null 2>&1
